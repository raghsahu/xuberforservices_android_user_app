...
public class Home extends AppCompatActivity implements NavigationDrawerFragment.NavDrawerFgmtListener, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener,
        NavigationCallBack, ServiceFlowFragment.ServiceFlowFgmtListener, HomeCategoryFragment.HomeCategoryFgmtListener, SubServiceFragment.SubServiceFgmtListener, PastTrips.PastTripsListener {
    ...
    @Override
    public void moveToSubServiceFragment() {
        SubServiceFragment subServiceFragment=SubServiceFragment.newInstance();
        addFragment(subServiceFragment,SubServiceFragment.TAG,false,true,true);
