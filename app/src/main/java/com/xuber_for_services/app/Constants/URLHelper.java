...
public class URLHelper {
    ...
    public static final String CLIENT_SECRET_KEY = "ufB7FMI6Pvi5FxoZGXhjUFtY1cGHtRMIbzehSaK5";
    ...
    public static final String LOGIN1 = BASE_URL +"api/user/login";
    ...
    public static final String GET_SUB_SERVICE_LIST_API = BASE_URL +"api/user/sub_services?service_id=";
   // http://erapidservice.com/public/api/user/sub_services?service_id=1
